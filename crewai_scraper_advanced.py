...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog = (
            "examples:\n"
            "  python crewai_scraper_advanced.py (same as --help)\n"
            "  python crewai_scraper_advanced.py --site 'FDIC'\n"
            "  python crewai_scraper_advanced.py --loop 60\n"
            "  python crewai_scraper_advanced.py --site 'FDIC' --loop 30\n"
            "  python crewai_scraper_advanced.py --loop 60 --once\n"
            "  python crewai_scraper_advanced.py --site 'FDIC' --loop 30 --once"
        ),
